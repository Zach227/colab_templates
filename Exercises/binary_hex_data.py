...
data = {
    ...
    "section1_body": [
        ...
        "  ",
        "Now what if you want to represent a decimal number in binary?",
        "Let's try converting the number 53 into binary.",
        ...
        "&nbsp;1&nbsp; 1 &nbsp;_ _ &nbsp;_ _  ",
        "  ",
        "We just keep repeating this process until we have filled out every bit.",
        "  ",
    ...
    "section2_body": [
        ...
        "But wait, we only have digits 0-9, how can we represent 10 or 11 with just one digit?",
        "The convention is to use the first 6 letters of the alphabet to reach 15.",
    ...
    "section2_questions": [
        Question("Q1", "print_frq_grid(7)"),
        Question("Q2", "print_frq_grid(8)"),
        Question("Q3", "print_frq_grid(9)"),
        Question("Q4", "print_frq_grid(10)"),
        Question("Q5", "print_frq_grid(11)"),
        Question("Q6", "print_frq_grid(12)"),
    ],
}
